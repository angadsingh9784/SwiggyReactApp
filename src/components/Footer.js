        ...
        <footer style={{ backgroundColor: mode === 'dark' ? 'black' : '' }} class="text-black bg-gray-200 body-font mt-24">
            <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    <a class="flex title-font font-medium items-center md:justify-start justify-center text-white" href='www.linkedin.com/in/angad-singh2001/'>
            ...
            <div style={{ backgroundColor: mode === 'dark' ? 'black' : '' }} class="bg-gray-200 bg-opacity-75">
                <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p style={{ color: mode === 'dark' ? 'white' : '' }} class="text-black text-sm text-center sm:text-left">© 2023  —
                        <a style={{ color: mode === 'dark' ? 'white' : '' }} href="www.linkedin.com/in/angad-singh2001/" rel="noopener noreferrer" class="text-black ml-1" target="_blank">@Angad Singh </a><br/>
                        <a style={{ color: mode === 'dark' ? 'white' : '' }} href="www.linkedin.com/in/angad-singh2001/" rel="noopener noreferrer" class="text-black ml-1" target="_blank">👳‍♂️ angad_ramgarhiia</a>

                    </p>
                    <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                        <a style={{ color: mode === 'dark' ? 'white' : '' }} class="text-black  cursor-pointer" >
                            <svg href='www.linkedin.com/in/angad-singh2001/' fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                            </svg>
                        </a>
                        <a style={{ color: mode === 'dark' ? 'white' : '' }} class="ml-3 text-black cursor-pointer" href='www.linkedin.com/in/angad-singh2001/'>
